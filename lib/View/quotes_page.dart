            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                image: DecorationImage(
                    image: AssetImage(bg[controller.bgIndex.value]),
                    fit: BoxFit.cover,
                    opacity: 0.8),
              ),
              child: PageView.builder(
                scrollDirection: Axis.vertical,
                itemCount: likeController.favouriteList.length,
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            Container(
                                ...
                                child: Text(
                                  '${likeController.favouriteList[index]['category']}',
                                  style: TextStyle(
                        ...
                        Obx(() => Center(
                                child: Text(
                                  likeController.favouriteList[index]['quote'],
                              style: TextStyle(
                                  color: controller.chooseColor.value,
                                  fontSize: controller.size.value.toDouble()),
                              textAlign: controller.alignText.value,
                            ))),
                        Text(likeController.favouriteList[index]['author'],
                            style: TextStyle(
                                color: controller.chooseColor.value,
                                fontSize: controller.size.value.toDouble()),
                            textAlign: controller.alignText.value),
                        ...
                        //           0, controller.dataList[index]['no']);
                        //       likeController.favourite(
                        //           0, likeController.favouriteList[index]['id']);
                        //       likeController.removeData(
                        //           likeController.favouriteList[index]['id']);
                                                                    ...
                                                                    (index) =>
                                                                      ...
                                                                      child: Text(
                                                                        ...
                                                                        style: TextStyle(
                                                                            color: Colors
                                                                                .white,
                                                                            fontFamily: controller.fonts[index]
                                                                                .toString(),
                                                                            fontSize:
                                                                                height * 0.023),
                                                                      ),
